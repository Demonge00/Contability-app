# Generated by Django 5.1.1 on 2025-01-18 16:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('observation', models.TextField(max_length=200, null=True)),
                ('deliver_receip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='delivered_products', to='api.deliverreceip')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('actual_cost_of_product', models.FloatField(blank=True, null=True)),
